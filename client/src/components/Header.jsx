...
const Header = () => {
  ...
  const categoryLinks = [
    {
      to: "/category/legume-conservate-horeca",
      label: t("Legume conservate HORECA"),
    },
    ...
    {
      to: "/category/produse-din-branza",
      label: t("Produse din brânză"),
    },
    {
      to: "/category/dulciuri-si-snacks-uri",
      label: t("Dulciuri și snacks-uri"),
    },
    {
      to: "/category/cafea-si-bauturi",
      label: t("Cafea și băuturi"),
    },
    { to: "/category/sosuri", label: t("Sosuri") },
    { to: "/category/masline", label: t("Măsline") },
    {
      to: "/category/alimente-cu-amidon",
      label: t("Alimente cu amidon"),
    },
    ...
    <header className="header">
      ...
      <div className="header__mobile">
        <div className="header-mobile__top">
          <Link
            to="/"
            className="header-mobile__logo-wrap"
        ...
        <form className="header-mobile__search" onSubmit={handleSearch}>
          <input
            ...
            disabled={isAdmin}
          />
          <button type="submit" disabled={isAdmin} aria-label="Search">
            <FaSearch />
          </button>
        </form>
        ...
        <div className={`header-mobile__menu ${mobileMenuOpen ? "is-open" : ""}`}>
          <button
            ...
            onClick={() =>
              !isAdmin && setMobileCategoriesOpen((prev) => !prev)
            }
            disabled={isAdmin}
          >
            <span>
          ...
          <div className="header-mobile__quicklinks">
            {mainLinks.map((item) =>
              isAdmin ? (
                <span
                  key={item.to}
                  className="nav-disabled header-mobile__pill"
                >
                  {item.label}
                </span>
              ) : (
          ...
          <div className="header-mobile__account">
            {user ? (
              <>
                ...
                <div
                  className={`header-mobile__account-links ${
                ...
                >
                  {isAdmin ? (
                    ...
                    <>
                      ...
                      <Link to="/my-orders" onClick={closeAllMenus}>
                        📦 My Orders
                      </Link>
                    </>
                  )}
